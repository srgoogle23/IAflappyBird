class Matrix {
    ...
    static multiply(a, b) { // Matrix product
        if (a.cols !== b.rows) {
            console.log('Columns of A must match rows of B.');
            return;
        }

        return new Matrix(a.rows, b.cols).map((e, i, j) => { // Dot product of values in col
            let sum = 0;
    ...
    static map(matrix, func) { // Apply a function to every element of matrix
